...
import { monthLabel, formatAmount } from '@finanzas/core/lib/constants'
      ...
      <div className="bg-white px-4 pt-10 pb-2 shadow-sm">
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <div className="flex items-center gap-1 min-w-0">
            <button onClick={prevMonth} aria-label="Mes anterior" className="p-1 rounded-full hover:bg-gray-100 transition-colors">
              <ChevronLeft size={12} className="text-gray-400" />
            </button>
            <p className="text-gray-700 font-semibold text-xs capitalize leading-none whitespace-nowrap">
              {monthLabel(currentMonth)}
            </p>
            <button onClick={nextMonth} aria-label="Mes siguiente" className="p-1 rounded-full hover:bg-gray-100 transition-colors">
