...
export default function Toast() {
  ...
  return (
    <div
      className={`fixed bottom-24 left-1/2 -translate-x-1/2 z-[100] flex items-center gap-2.5 px-4 py-3 rounded-2xl shadow-lg text-white text-sm font-semibold max-w-[340px] w-[90vw] toast-enter ${
